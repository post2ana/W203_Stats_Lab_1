...
hist(CEO$salary, breaks = seq(0,6,.2),
     xaxt = "n",
     main = "Histogram of CEO Salary Data",
     xlab = "CEO Salary (in $ millions)")
axis(1, seq(0,6,1))
...
#    labels = T,
     ...
     xlab = "Profit in millions(dollars)")
```
